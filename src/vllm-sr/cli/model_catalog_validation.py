...
from cli.model_catalog_types import CatalogCompatibility, ModelCatalogError
...
def _compatibility(value: Any) -> CatalogCompatibility:
    mapping = value if isinstance(value, dict) else {}
    current = _version_tuple(__version__)
    if current is None:
        return CatalogCompatibility(False, "installed CLI version is unknown")
...
def _required_version_tuple(value: str) -> tuple[int, int, int]:
