...
- Reference routing profile: [config.yaml](../../../config/recipes/balance/config.yaml)
  - canonical authoring surface: [recipe.dsl](../../../config/recipes/balance/recipe.dsl)
  - executable probe manifest: [probes.yaml](../../../config/recipes/balance/probes.yaml)
